...
const AdminMessages: React.FC = () => {
  ...
  const renderRow = (user: User) => {
    ...
    return (
        ...
        >
            <div className="w-12 h-12 rounded-full bg-sky-100 dark:bg-sky-900 flex items-center justify-center text-sky-600 dark:text-sky-400 overflow-hidden relative flex-shrink-0">
                {user.avatar ? (
            ...
            <div className="flex-1 overflow-hidden min-w-0">
                <div className="flex justify-between mb-1">
                    <h3 className={`font-bold text-slate-800 dark:text-white truncate ${unreadCount > 0 ? 'text-sky-600 dark:text-sky-400' : ''}`}>{user.name}</h3>
