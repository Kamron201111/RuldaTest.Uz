...
const Badges: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-sky-500 to-cyan-500 dark:from-sky-900 dark:to-cyan-900 rounded-2xl p-6 text-white">
        ...
        <div className="mt-4 grid grid-cols-2 gap-4">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3">
            <p className="text-sm text-sky-100">Olgan nishonlar</p>
            <p className="text-2xl font-bold">
              {earnedBadges.length}/{BADGES.length}
            </p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3">
            <p className="text-sm text-sky-100">Daraja</p>
