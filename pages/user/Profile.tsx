              ...
              <div className="relative px-6 sm:px-8 pb-8">
                ...
                <form onSubmit={handleSave} className="space-y-5">
                  ...
                  <div className="space-y-4 p-4 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-700/30 dark:to-slate-600/30 rounded-xl border-2 border-slate-200 dark:border-slate-700">
                    ...
                    <div className="flex items-start gap-2 text-xs text-slate-600 dark:text-slate-400 bg-sky-50 dark:bg-sky-900/20 px-3 py-2 rounded-lg border border-sky-200 dark:border-sky-700">
                      <Shield className="w-4 h-4 mt-0.5 flex-shrink-0 text-sky-600 dark:text-sky-400" />
                      <div>
