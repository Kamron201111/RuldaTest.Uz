...
const StudyMaterials: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-cyan-500 to-purple-600 dark:from-cyan-900 dark:to-purple-900 rounded-2xl p-6 text-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredMaterials.map((material) => (
            <div
              ...
              className="bg-white dark:bg-slate-800 rounded-xl p-5 border border-slate-200 dark:border-slate-700 hover:border-sky-400 dark:hover:border-sky-400 cursor-pointer transition-all group hover:shadow-lg"
            >
              <div
              ...
              <h3 className="font-bold text-slate-800 dark:text-white mb-2 group-hover:text-sky-600 dark:group-hover:text-sky-400">
                {material.title}
              </h3>
              ...
              <div className="flex items-center justify-between">
                ...
                <ExternalLink className="w-4 h-4 text-slate-400 group-hover:text-sky-600 dark:group-hover:text-sky-400" />
              </div>
            </div>
          ))}
        </div>
