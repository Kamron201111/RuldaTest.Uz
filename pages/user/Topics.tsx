      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6 space-y-4 sm:space-y-6">
        ...
        {totalQuestions === 0 ? (
          <div className="bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl p-8 sm:p-12 border border-slate-200 dark:border-slate-700 shadow-sm text-center">
            ...
            <button
              onClick={() => navigate("/user")}
              className="px-4 sm:px-6 py-2 sm:py-3 bg-sky-500 hover:bg-sky-600 text-white text-sm sm:text-base font-medium rounded-lg transition-colors shadow-lg"
            >
          ...
          <>
                ...
                return (
                  <div
                    ...
                    className={`bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 border-2 transition-all shadow-sm ${
                      hasQuestions
                        ? "border-slate-200 dark:border-slate-700 hover:border-sky-400 dark:hover:border-sky-300 cursor-pointer group hover:shadow-xl hover:-translate-y-1 active:scale-98"
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-slate-200 dark:border-slate-700">
                      ...
                      {hasQuestions && (
                        <div className="flex items-center gap-1.5 text-sky-600 dark:text-sky-400 text-sm font-medium group-hover:gap-2.5 transition-all">
                          <span>Boshlash</span>
                          <svg
            ...
            {/* Info Box */}
            <div className="bg-sky-50 dark:bg-sky-900/20 border border-sky-200 dark:border-sky-700 rounded-lg sm:rounded-xl p-3 sm:p-4">
