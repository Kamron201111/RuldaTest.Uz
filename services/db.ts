...
const STORAGE_KEYS = {
  QUESTIONS: 'ruldatest_questions',
  RESULTS: 'ruldatest_results',
  USERS: 'ruldatest_users',
  ACTIVITY_LOGS: 'ruldatest_activity_logs',
  CHAT_MESSAGES: 'ruldatest_conversations',
  USER_PROGRESS: 'ruldatest_user_progress',
  FRIENDS: 'ruldatest_friends',
  CHALLENGES: 'ruldatest_challenges',
  BOOKMARKS: 'ruldatest_bookmarks',
  STUDY_MATERIALS: 'ruldatest_study_materials',
  USER_GOALS: 'ruldatest_user_goals',
};
...
const PREMIUM_KEY = 'ruldatest_premium';
const DAILY_TEST_KEY = 'ruldatest_daily_tests';
